...
namespace CRMWinApp.Forms
{
    ...
    {
        private List<Models.Permission> cPermissionList;
        /// <summary>
        ...
        public void SetPermissions( List<Models.Permission> permissionList )
        {
            cPermissionList = permissionList;
        }
